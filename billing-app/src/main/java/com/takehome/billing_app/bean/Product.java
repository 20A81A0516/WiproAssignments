package com.takehome.billing_app.bean;
...
public class Product {
    ...
    public Product(int product_code, String product_name, String product_category, String product_description, double product_price) {
